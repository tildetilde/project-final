...
export const adminLogin = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Admin login error', 'AdminController', error as Error);
...
export const adminLogout = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Admin logout error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const getAdminProfile = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Get admin profile error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const getAllCategories = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Get categories error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const getCategoryById = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Get category error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const createCategory = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Create category error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const updateCategory = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update category error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const deleteCategory = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Delete category error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const getAllItems = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Get items error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const getItemById = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Get item error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const createItem = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Create item error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const updateItem = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update item error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
...
export const deleteItem = async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Delete item error', 'AdminController', error as Error);
    const response = ResponseBuilder.internalError('Internal server error', req);
    res.status(500).json(response);
  }
};
